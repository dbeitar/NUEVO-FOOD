...
function toPrisma(legacy) {
  return {
    ...
    faviconUrl: legacy.favicon_url || null,
    coverUrl: legacy.cover_url || null,
    socialLinks: legacy.social_links && typeof legacy.social_links === 'object' ? legacy.social_links : {},
    customDomain: legacy.custom_domain || null,
