...
La Aplicación se proporciona "tal cual" sin garantías. No nos responsabilizamos por:
- Lesiones, enfermedades u otros daños derivados del uso de la Aplicación
- Información incorrecta o desactualizada sobre alimentos
...
Todos los contenidos de la Aplicación (código, diseño, texto, imágenes, gráficos) son propiedad de D28D Gimnasio Virtual o sus licenciantes. Usted recibe una licencia limitada para usar la Aplicación únicamente para fines personales y no comerciales.

**Está prohibido:**
- Copiar o reproducir contenidos
- Modificar o crear trabajos derivados
- Vender o comercializar la Aplicación o contenidos
- Usar para fines competitivos
...
- Modificar o mejorar la Aplicación en cualquier momento
- Rescindir o suspender el servicio sin previo aviso en casos de abuso
- Cambiar tarifas o características
- Descontinuar características específicas

## 9. PROHIBICIÓN DE ABUSO

**Uso prohibido incluye:**
- Scraping automatizado de datos
- Intentos de hackeo o acceso no autorizado
- Distribución de malware o código malintencionado
- Spam, acoso o abuso verbal
- Carga de contenido ofensivo o ilegal
- Violación de derechos de terceros

Se tomarán acciones legales contra usuarios que abusen del servicio.

## 10. LIMITACIÓN DE RESPONSABILIDAD

La responsabilidad máxima de D28D Gimnasio Virtual en ningún caso excederá lo pagado por el usuario en los últimos 12 meses (o $0 si es gratis).

## 11. INDEMNIZACIÓN

Usted se compromete a indemnizar y defender a D28D Gimnasio Virtual de reclamaciones, daños y gastos (incluyendo honorarios legales) derivados de:
- Su incumplimiento de estos términos
- Su uso indebido de la Aplicación
- Violación de derechos de terceros
- Lesiones o daños derivados de su uso del servicio

## 12. RESOLUCIÓN DE DISPUTAS

### 12.1 Negociación amistosa
Cualquier disputa será resuelta primero mediante negociación de buena fe.

### 12.2 Arbitraje
Si no se resuelve, se someterá a arbitraje bajo las leyes de Colombia.

### 12.3 Acuerdos parciales
Si alguna disposición es inválida, el resto permanecerá en vigencia.

## 13. DATOS Y PRIVACIDAD

Vea nuestra Política de Privacidad para información completa sobre:
...
- **Portal de Soporte**: support.foodplan.app

## 15. VIGENCIA

Estos Términos entran en vigencia el 20 de febrero de 2026 y continuarán hasta que uno de nosotros los rescinda. Sin embargo, ciertas disposiciones (como limitación de responsabilidad) sobrevivirán la rescisión.

---

**RECONOCIMIENTO:** 

Al hacer clic en "ACEPTAR" durante el registro, usted reconoce que:

✓ Ha leído estos Términos y Condiciones
✓ Ha leído la Política de Privacidad
✓ Comprende que D28D Gimnasio Virtual NO es asesor médico
✓ Acepta asumir toda responsabilidad por su uso de la Aplicación
✓ Acepta todos los términos y condiciones sin reservas

**ÚLTIMA ACEPTACIÓN: 20 de febrero de 2026**
