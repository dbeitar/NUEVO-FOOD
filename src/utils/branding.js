...
export const PUBLIC_BRAND_NAME = fromEnv('VITE_BRAND_NAME', 'FOODPLAN Platform');
export const PUBLIC_BRAND_TAGLINE = fromEnv('VITE_BRAND_TAGLINE', 'Nutrición, entrenamiento y comunidad en una sola cuenta.');
