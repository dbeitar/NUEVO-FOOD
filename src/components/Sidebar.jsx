...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { path: '/calculator', label: t('nav.calculator', 'Calculadora'), icon: (
      <svg className="w-5 h-5 transition-colors group-hover:text-lime-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
      </svg>
    )},
    { path: '/food-log', label: t('nav.foods', 'Banco de Alimentos'), icon: (
      <svg className="w-5 h-5 transition-colors group-hover:text-lime-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    { path: '/programs', label: 'Programas D28D', icon: (
      <svg className="w-5 h-5 transition-colors group-hover:text-lime-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
      </svg>
    )},
    { path: '/my-account', label: t('nav.myaccount', 'Mi Cuenta'), icon: (
      <svg className="w-5 h-5 transition-colors group-hover:text-lime-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  if (user && ['super_admin', 'admin_gimnasio'].includes(user.rol)) {
    navItems.push({ path: '/admin', label: t('nav.admin', 'Admin'), icon: (
